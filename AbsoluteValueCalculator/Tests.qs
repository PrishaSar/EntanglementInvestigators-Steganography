namespace files {
    ...
    @Test("QuantumSimulator")
    operation COtest3() : Unit { //1011101 -> 100011
        use input = Qubit[7];
        use output = Qubit[6];
        
        X(input[0]);
        ApplyToEach(X, input[2..4]);
        X(input[6]);
    ...
    @Test("QuantumSimulator")
    operation CAVtest1() : Unit { //111-111 -> 000
        use a = Qubit[3];
        use b = Qubit[3];
        use output = Qubit[3];
    ...
    @Test("QuantumSimulator")
    operation CAVtest2() : Unit { //101-110 -> 001
        use a = Qubit[3];
        use b = Qubit[3];
        use output = Qubit[3];
    ...
    @Test("QuantumSimulator")
    operation CAVtest3() : Unit { //01-10 -> 11
        use a = Qubit[2];
        use b = Qubit[2];
        use output = Qubit[2];
